 ...
 * @LastEditors: iowen
 * @LastEditTime: 2021-06-02 06:43:11
...
function isPC() {
      let e = navigator.userAgent,
            t = ["Android", "iPhone", "webOS", "BlackBerry", "SymbianOS", "Windows Phone", "iPad", "iPod"],
            i = !0;
...
function showAlert(e) {
      ...
      switch (e.status) {
            case 1:
                  t = localize.successAlert,
                        i = "success",
                        a = "icon-adopt";
                  break;
            case 2:
                  t = localize.infoAlert,
                        i = "info",
                        a = "icon-tishi";
                  break;
            case 3:
                  t = localize.warningAlert,
                        i = "warning",
                        a = "icon-warning";
                  break;
            case 4:
                  t = localize.errorAlert,
                        i = "danger",
                        a = "icon-close-circle"
      }
      var s = e.msg;
      ...
      $("#alert_placeholder").append(o),
            o.show(200).delay(3500).hide(300, function () {
                  $(this).remove()
            })
}
function toTarget(e, t, i) {
      var a = e.children(".anchor"),
            s = e.children(".hover").first();
      s && 0 < s.length || (s = i ? e.find(".active").parent() : e.find(".active")),
            0 < s.length ? t ? a.css({
...
!function (e) {
      e(document).ready(function () {
            "1" != theme.minNav && l(),
                  ...
                  function () {
                        ...
                        toTarget(e(".s-type-list.big"), !1, !1),
                              e(".hide-type-list .s-current").removeClass("s-current"),
                              e('.hide-type-list input:radio[name="type"]:checked').parents(".search-group").addClass("s-current"),
                              e('.hide-type-list input:radio[name="type2"]:checked').parents(".search-group").addClass("s-current"),
                              e(".super-search-fm").attr("action", e(".hide-type-list input:radio:checked").val()),
                              e(".search-key").attr("placeholder", e(".hide-type-list input:radio:checked").data("placeholder")),
                              "type-zhannei" == window.localStorage.getItem("searchlist") && e(".search-key").attr("zhannei", "true")
                  }(),
                  s(),
                  isPC() ? e('[data-toggle="tooltip"]').tooltip({
                        trigger: "hover"
                  }) : e('.qr-img[data-toggle="tooltip"]').tooltip({
                        trigger: "hover"
                  }),
                  e(".slider_menu[sliderTab]").each(function () {
                  ...
                  "1" == theme.isCustomize && (p(!1), p(!0)),
                  e(window).scrollTop() >= 50 && (e("#go-to-up").fadeIn(200), e(".big-header-banner").addClass("header-bg"))
      }),
      ...
      function a(t) {
            var i = e("body"),
                  a = e(".switch-dark-mode"),
                  s = e(".mode-ico");
            i.hasClass("io-black-mode") ? (t && setCookie("io_night_mode", 0, 30), a.attr("data-original-title") ? a.attr("data-original-title", localize.lightMode) : a.attr("title", localize.lightMode), s.removeClass("icon-night").addClass("icon-light")) : (t && setCookie("io_night_mode", 1, 30), a.attr("data-original-title") ? a.attr("data-original-title", localize.nightMode) : a.attr("title", localize.nightMode), s.removeClass("icon-light").addClass("icon-night"))
      }
      function s() {
            if (e(".main-footer").attr("style", ""), e(".main-footer").hasClass("text-xs")) {
                  var t = jQuery(window).height(),
                        i = e(".main-footer").outerHeight(!0),
                        a = e(".main-footer").position().top + i;
                  t > a - parseInt(e(".main-footer").css("marginTop"), 10) && e(".main-footer").css({
                        marginTop: t - a
                  })
            }
      }
      e(window).resize(function () {
            ...
            e(document).on("click", "a[target!='_blank']", function () {
                  if (isPC() && "1" == theme.loading && e(this).attr("href") && 0 != e(this).attr("href").indexOf("#") && 0 != e(this).attr("href").indexOf("java") && !e(this).data("fancybox") && !e(this).data("commentid") && !e(this).hasClass("nofx")) {
                        ...
                        e("body").prepend(t),
                              t.animate({
                                    opacity: "1"
                              }, 200, "swing").delay(2e3).hide(300, function () {
                                    t.remove()
                              })
                  }
            }),
                  ...
                  if ("post_like" == t.data("action"))
                        ...
                        t.hasClass("liked") && (a = 1),
                              ...
                              e.ajax({
                                    ...
                                    success: function (i) {
                                          if (t.removeClass("disabled"), 1 == i.status)
                                                return e(".star-count-" + s).html(i.count), 1 == a ? (t.removeClass("liked"), t.find(".star-ico").removeClass("icon-collection").addClass("icon-collection-line")) : (t.addClass("liked"), t.find(".star-ico").removeClass("icon-collection-line").addClass("icon-collection")), ioPopupTips(i.status, i.msg), !1;
                        ...
                        e(this).addClass("liked"),
                              e.ajax({
                                    ...
                                    success: function (a) {
                                          ...
                                          t.prepend(s),
                                                showAlert(JSON.parse('{"status":1,"msg":"' + localize.like + '"}')),
                                                e(".home-like-" + i).html(a),
                                                s.addClass("home-like-hide")
                                    },
                                    error: function () {
                                          showAlert(JSON.parse('{"status":4,"msg":"' + localize.networkerror + '"}'))
                                    }
            ...
            e(document).on("click", ".switch-dark-mode", function (t) {
                  t.preventDefault(),
                        e("body").toggleClass("io-black-mode " + theme.defaultclass),
                        a(!0),
                        e("#" + e(".switch-dark-mode").attr("aria-describedby")).remove()
            }),
            ...
            e("#sidebar-switch").on("click", function () {
                  e("#sidebar").removeClass("mini-sidebar"),
                        e(".sidebar-nav .change-href").attr("href", "javascript:;")
            });
      var o = !1,
            n = !1;
      function l() {
      ...
      function d(t, i, a) {
            t.hasClass("active") || (i.find("a").removeClass("active"), t.addClass("active"), 0 == e(a).children(".ajax-loading").length && e(a).append('<div class="ajax-loading text-center rounded" style="position:absolute;display:flex;left:0;width:100%;top:-1rem;bottom:.5rem;background:rgba(125,125,125,.5)"><div class="col align-self-center"><i class="iconfont icon-loading icon-spin icon-2x"></i></div></div>'), e.ajax({
                  ...
                  if (i.trim()) {
                        ...
                        s ? t.parents(".d-flex.flex-fill.flex-tab").children(".btn-move.tab-move").show().attr("href", s) : t.parents(".d-flex.flex-fill.flex-tab").children(".btn-move.tab-move").hide(),
                              isPC() && e('.ajax-url [data-toggle="tooltip"]').tooltip({
                                    trigger: "hover"
                              })
                  } else
      ...
      e(".sidebar-menu-inner a").on("click", function () {
            ...
            e("#mini-button").on("click", function () {
                  e(".sidebar-nav").hasClass() || e(".sidebar-nav").addClass("animate-nav"),
                        r()
            }),
            e(document).on("mouseenter", ".mini-sidebar .sidebar-menu ul:first>li,.mini-sidebar .flex-bottom ul:first>li", function () {
                  var t = 2;
                  0 != e(this).parents(".flex-bottom").length && (t = -3),
                        0 == e(".sidebar-popup.second").length && e("body").append("<div class='second sidebar-popup sidebar-menu-inner text-sm'><div></div></div>"),
                        e(".sidebar-popup.second>div").html(e(this).html()),
                        e(".sidebar-popup.second").show();
                  var i = e(this).offset().top - e(window).scrollTop() + t,
                        a = e(window).height() - e(".sidebar-popup.second>div").height();
                  a - i <= 0 && (i = a >= 0 ? a - 8 : 0),
                        e(".sidebar-popup.second").stop().animate({
                              top: i
                        }, 50),
                        e(this).one("mouseleave", function () {
            ...
            e(document).on("click", ".ajax-cm-home .ajax-cm", function (t) {
                  ...
                  var i = e(this),
                        a = i.data("id"),
                        s = e(i.attr("href")).children(".site-list");
                  0 == s.children(".url-card").length && (i.addClass("disabled"), e.ajax({
                        ...
                        if (t.trim()) {
                              var a = e(t);
                              s.html(a),
                                    isPC() && a.find('[data-toggle="tooltip"]').tooltip({
                                          trigger: "hover"
                                    })
                        }
            ...
            e(document).on("click", ".ajax-list a", function (t) {
                  t.preventDefault(),
                        d(e(this), e(this).parents(".ajax-list"), "." + e(this).data("target"))
            }),
            e(document).on("click", ".ajax-list-home a", function (t) {
                  t.preventDefault(),
                        d(e(this), e(this).parents(".ajax-list-home"), ".ajax-" + e(this).parents(".ajax-list-home").data("id"))
            }),
            e(".add-link-form").on("submit", function () {
                  var t = e(".site-add-name").val(),
                        i = e(".site-add-url").val();
                  !function (e) {
                        for (var t = m("myLinks"), i = 0; i < t.length; i++)
                              if (t[i].url == e.url)
                                    return void showAlert(JSON.parse('{"status":4,"msg":"' + localize.urlExist + '"}'));
                        t.unshift(e),
                              h(e, !1, !1),
                              u(t, "myLinks")
                  }({
                        ...
                        e(this).find(".btn-close-fm").click()
            });
      var c = !1;
      function h(t, i, a) {
            i ? e(".customize_nothing_click").remove() : e(".customize_nothing").remove();
            var s,
                  o = t.url.match(/^(?:https?:\/\/)?((?:[-A-Za-z0-9]+\.)+[A-Za-z]{2,6})/);
            ...
            i ? (a ? e(".my-click-list").prepend(n) : e(".my-click-list").append(n), n.children(".remove-site").on("click", v)) : (e("#add-site").before(n), n.children(".remove-site").on("click", f)),
                  c && n.children(".remove-site").show(),
                  isPC() && e('.new-site[data-toggle="tooltip"]').tooltip({
                        trigger: "hover"
                  })
      }
      function m(e) {
      ...
      function p(t) {
            ...
            if (!i.length || t || e("#add-site")[0]) {
                  ...
                  e(".customize_nothing.custom-site").children(".nothing").html('<a href="javascript:;" class="add-new-custom-site" data-action="add_custom_urls" data-term_name="我的导航" data-urls="' + Base64.encode(JSON.stringify(i)) + '" >您已登录，检测到您的设备上有数据，点击<strong style="color:#db2323">同步到服务器</strong>。</a>')
      }
      function f() {
            for (var t = e(this).data("id"), i = m("myLinks"), a = 0; a < i.length; a++)
                  if (parseInt(i[a].id) === parseInt(t)) {
                        console.log(i[a].id, t),
                              i.splice(a, 1);
                        break
                  }
            u(i, "myLinks"),
      ...
      function v() {
            for (var t = e(this).data("id"), i = m("livelists"), a = 0; a < i.length; a++)
                  if (parseInt(i[a].id) === parseInt(t)) {
                        console.log(i[a].id, t),
                              i.splice(a, 1);
                        break
            ...
            e(".customize-sites").hasClass("edit") ? (isPC() && e('.customize-sites .new-site[data-toggle="tooltip"]').tooltip("disable"), e(".customize-sites .site-list").sortable({
                  ...
                  update: function (t, i) {
                        ...
                        e.ajax({
                              ...
                              dataType: "json",
                              success: function (t) {
                                    1 != t.status && showAlert(t),
                                          e(".customize-sites .site-list").sortable("enable")
                              },
                              error: function (t) {
                                    e(".customize-sites .site-list").sortable("enable"),
                                          showAlert(JSON.parse('{"status":4,"msg":"' + localize.networkerror + '"}'))
            ...
            e.ajax({
                  ...
                  success: function (t) {
                        ...
                        if (a.children("ul").text(""), x = t[1].length) {
                              for (var s = 0; s < x; s++)
                                    a.children("ul").append("<li>" + t[1][s] + "</li>"),
                                          a.find("li").eq(s).click(function () {
                                                var t = e(this).html();
                                                i.find(".smart-tips.search-key").val(t),
                                                      i.children(".super-search-fm").submit(),
                                                      a.slideUp(200)
                                          });
                              a.slideDown(200)
                        } else
            ...
            e.ajax({
                  ...
                  success: function (t) {
                        ...
                        if (a.children("ul").text(""), x = t.s.length) {
                              for (var s = 0; s < x; s++)
                                    a.children("ul").append("<li>" + t.s[s] + "</li>"),
                                          a.find("li").eq(s).click(function () {
                                                var t = e(this).html();
                                                i.find(".smart-tips.search-key").val(t),
                                                      i.children(".super-search-fm").submit(),
      ...
      e(".customize-menu .btn-edit").click(function () {
            ...
            e(".add-custom-site-form").on("submit", function () {
                  var t = e(this),
                        i = this,
                        a = t.find("input[name=url]").val(),
                        s = t.find("input[name=url_name]").val(),
                        o = t.find("input:radio:checked").val();
                  if ("" == t.find("input[name=term_name]").val() && null == o)
                        return showAlert(JSON.parse('{"status":3,"msg":"' + localize.selectCategory + '"}')), !1;
                  e.ajax({
                        url: theme.ajaxurl,
                        type: "POST",
                        dataType: "json",
                        ...
                        if (1 == n.status) {
                              var l,
                                    r = a.match(/^(?:https?:\/\/)?((?:[-A-Za-z0-9]+\.)+[A-Za-z]{2,6})/);
                              ...
                              e(".add-custom-site[data-term_id=" + o + "]").before(c),
                                    i.reset(),
            ...
            e(document).on("click", ".url-card a.card", function (t) {
                  var i = {
                        id: e(this).data("id"),
                        name: e(this).find("strong").html(),
                        url: e(this).data("url")
                  };
                  if ("" !== i.url) {
                        for (var a = m("livelists"), s = !0, o = 0; o < a.length; o++)
                              a[o].name === i.name && (s = !1);
                        if (s) {
                              var n = theme.customizemax;
                              a.length > n - 1 && (e(".my-click-list .site-" + a[n - 1].id).parent().remove(), a.splice(n - 1, 1)),
                                    h(i, !0, !0),
                                    a.unshift(i),
                                    u(a, "livelists")
                        }
            ...
            e(document).on("click", ".s-type-list label", function (t) {
                  e(".s-type-list.big label").removeClass("active"),
                        e(this).addClass("active"),
                        window.localStorage.setItem("searchlistmenu", e(this).data("id"));
                  var i = e(this).parents(".s-search");
                  i.find(".search-group").removeClass("s-current"),
                        i.find("#" + e(this).attr("for")).parents(".search-group").addClass("s-current"),
                        toTarget(e(this).parents(".s-type-list"), !1, !1)
            }),
            e(".hide-type-list .search-group input").on("click", function () {
                  var t = e(this).parents(".s-search");
                  window.localStorage.setItem("searchlist", e(this).attr("id").replace("m_", "")),
                        t.children(".super-search-fm").attr("action", e(this).val()),
                        t.find(".search-key").attr("placeholder", e(this).data("placeholder")),
                        "type-zhannei" == e(this).attr("id") || "m_type-zhannei" == e(this).attr("id") ? t.find(".search-key").attr("zhannei", "true") : t.find(".search-key").attr("zhannei", ""),
      ...
      e(document).on("blur", ".smart-tips.search-key", function () {
            w = "",
                  e(".search-smart-tips").delay(150).slideUp(200)
      }),
            e(document).on("focus", ".smart-tips.search-key", function () {
                  if (C = "" != e(this).attr("zhannei"), w = e(this).parents("#search"), e(this).val() && !C)
            ...
            e(document).on("keyup", ".smart-tips.search-key", function (t) {
                  if (C = "" != e(this).attr("zhannei"), w = e(this).parents("#search"), e(this).val()) {
                        if (38 == t.keyCode || 40 == t.keyCode || C)
                              return;
                        switch (theme.hotWords) {
                              case "baidu":
                                    y(e(this).val(), w);
                        ...
                        e(".search-smart-tips").slideUp(200)
            }),
            e(document).on("keydown", ".smart-tips.search-key", function (t) {
                  if (w = e(this).parents("#search"), 40 === t.keyCode) {
                        k === x - 1 ? k = 0 : k++,
                              w.find(".search-smart-tips ul li").eq(k).addClass("current").siblings().removeClass("current");
            ...
            e("#add-new-sites-modal").on("show.bs.modal", function (t) {
                  var i = e(t.relatedTarget),
                        a = e(this);
                  a.find('[name="term_id"]').val(i.data("terms_id")),
                        a.find('[name="url"]').val(i.data("new_url")),
                        a.find('[name="url_name"]').val(""),
                        a.find('[name="url_summary"]').removeClass("is-invalid").val(""),
                        i.data("new_url", "");
      ...
      var _ = "";
      function z(t, i) {
            e("#modal-new-url-ico").show(),
                  e.post("//apiv2.iotheme.cn/webinfo/get.php", {
                        url: t,
                        key: theme.apikey
                  }, function (t, a) {
                        ...
                        e("#modal-new-url-ico").hide(),
                              e(".refre_msg").html('<i class="iconfont icon-tishi"></i>' + localize.timeout).show(200).delay(4e3).hide(200)
                  })
      }
...
function ioPopupTips(e, t, i) {
      ...
      $("body").addClass("modal-open").append(s),
            hasScrollbar() && $("body").css("padding-right", getScrollbarWidth()),
            setTimeout(function () {
                  $("body").removeClass("modal-open"),
                        hasScrollbar() && $("body").css("padding-right", ""),
                        $.isFunction(i) && i(!0),
                        s.removeClass("io-bomb-open").addClass("io-bomb-close"),
                        setTimeout(function () {
                              s.removeClass("io-bomb-close"),
                                    setTimeout(function () {
                                          s.remove()
                                    }, 200)
                        }, 400)
...
function ioPopup(e, t, i, a) {
      ...
      $("body").addClass("modal-open").append(o),
            hasScrollbar() && $("body").css("padding-right", getScrollbarWidth());
      return $(o).on("click touchstart", ".btn-close-bomb i, .io-bomb-overlay", function (e) {
            e.preventDefault(),
                  ...
                  $("body").removeClass("modal-open"),
                  hasScrollbar() && $("body").css("padding-right", ""),
                  $(o).removeClass("io-bomb-open").addClass("io-bomb-close"),
                  setTimeout(function () {
                        $(o).removeClass("io-bomb-close"),
                              setTimeout(function () {
                                    o.remove()
                              }, 200)
                  }, 600)
...
function ioConfirm(e, t) {
      var i = '\t<div class="io-bomb io-bomb-confirm io-bomb-open">\t\t<div class="io-bomb-overlay"></div>\t\t<div class="io-bomb-body">\t\t\t<div class="io-bomb-content bg-white">\t\t\t\t' + e + '                <div class="text-center mt-3">                    <button class="btn btn-danger mx-2" onclick="_onclick(true);">' + localize.okBtn + '</button>                    <button class="btn btn-light mx-2" onclick="_onclick(false);">' + localize.cancelBtn + "</button>                </div>\t\t\t</div>\t\t</div>\t</div>\t",
            a = $(i);
      $("body").addClass("modal-open").append(a),
            hasScrollbar() && $("body").css("padding-right", getScrollbarWidth()),
            _onclick = function (e) {
                  s(),
                        $.isFunction(t) && t(e)
      ...
      var s = function () {
            $("body").removeClass("modal-open"),
                  hasScrollbar() && $("body").css("padding-right", ""),
                  $(a).removeClass("io-bomb-open").addClass("io-bomb-close"),
                  setTimeout(function () {
                        $(a).removeClass("io-bomb-close"),
                              setTimeout(function () {
                                    a.remove()
                              }, 200)
                  }, 600)
...
function ChromBookmarkConverter() {
      this.bookmarks = {
            ...
            this.stripUnneededTags = function (a) {
            ...
            this.processDL = function (a, b, c) {
                  ...
                  $.each(i.children(), function (a, i) {
                        ...
                        e += 1,
                              k = b + "." + e,
                              1 == j && i.tagName.toLowerCase() != "DL".toLowerCase() && (j = !1, console.log("h3", f), g.items.push(f)),
                              i.tagName.toLowerCase() == "DL".toLowerCase() && (g = {
                                    type: "folder",
                                    title: f.title,
                                    add_date: f.add_date,
                                    last_modified: f.last_modified,
                                    items: []
                              }, 1 == j && (j = !1), d.bookmarks.folders.push(g), d.processDL(i, k, g)),
                              i.tagName.toLowerCase() == "H3".toLowerCase() && (l = $(i), m = l.text() ? l.text() : "未命名", n = l.attr("add_date"), o = l.attr("last_modified"), f = {
                                    type: "header",
                                    title: m,
                                    add_date: n,
                                    last_modified: o
                              }, j = !0),
                              "a" == i.tagName.toLowerCase() && isURL($(i).attr("href")) && "" != $(i).text() && (p = $(i), q = p.text(), r = p.attr("href"), s = p.attr("add_date"), p.attr("icon"), h = {
                                    type: "link",
                                    title: q,
                                    href: r,
                                    add_date: s
